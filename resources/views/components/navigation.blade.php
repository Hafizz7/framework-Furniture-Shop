...
<nav class="flex flex-row p-5 justify-center items-center bg-white z-10 sticky top-0">
    ...
    <div class="justify-end">
        <a href="#" class=" fixed top-4 left-[1211px] right-0 bg-blue-900 px-8 py-4 w-20 h-6 flex justify-center items-center rounded-md hover:bg-blue-950 hover:scale-125 mr-9 mb-19">
